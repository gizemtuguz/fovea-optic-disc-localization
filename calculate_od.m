...
predicted = readtable('optic_disc_coordinates.csv', 'ReadVariableNames', true, 'VariableNamingRule', 'preserve');
predicted = predicted(:, 1:3); 
predicted.Properties.VariableNames = {'Image', 'X_pred', 'Y_pred'};

gt = readtable('IDRiD_OD_Center_Testing Set_Markups.csv', 'ReadVariableNames', true, 'VariableNamingRule', 'preserve');
...
fprintf('OD Localization Metrics (Threshold: %d pixels)\n', threshold);
